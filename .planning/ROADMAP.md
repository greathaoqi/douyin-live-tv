...
- [ ] **Phase 7: Integration Gap Closure** - Fix cross-phase integration gaps identified in v1.0 audit (incomplete)
...
**Depends on:** Phase 5
**Requirements:** REFRESH-01, REFRESH-02, REFRESH-03, QOL-02
**Success Criteria** (what must be TRUE):
...
**Goal:** Fix cross-phase integration gaps to restore core functionality
**Depends on:** Phase 6
**Requirements:** AUTH-04, LIVE-02, FAV-01, REFRESH-02, QOL-01
**Success Criteria** (what must be TRUE):
  1. LiveStatsService uses AuthService for authenticated API requests (all requests include authorization header)
  2. LiveRoom model stores streamURL from API response for video playback
  3. Adding a new room completes successfully with valid room ID
...
- [x] 07-03-PLAN.md — Top Shelf compilation + deep link handling
